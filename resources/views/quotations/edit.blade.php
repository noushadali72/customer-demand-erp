<x-layouts.app title="Edit Quotation">
    ...
    <div class="mb-6 flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">
                Update quotation #{{ $quotation->quotation_number ?? $quotation->id }}.
            </p>
        </div>
        ...
        <div class="flex items-center gap-3 border-b bg-gray-50 px-6 py-4">
            ...
            <div>
                <h3 class="font-semibold text-gray-900">
                    Purchase Request #{{ $quotation->purchaseRequest->request_number }}
                </h3>
        ...
        <div class="p-6">
            ...
            <div class="mb-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
                ...
                <div class="rounded-lg border border-gray-200 bg-gray-50 p-4">
                    ...
                    <p class="mt-1">
                        <span class="inline-flex rounded-full bg-blue-100 px-3 py-1 text-xs font-medium capitalize text-blue-700">
                            {{ $quotation->purchaseRequest->status }}
                        </span>
                    </p>
                </div>
                ...
                <div class="rounded-lg border border-gray-200 bg-gray-50 p-4">
                    ...
                    <p class="mt-1 text-lg font-semibold text-gray-900">
                        {{ $quotation->purchaseRequest->created_at->format('d M Y') }}
                    </p>
                </div>

            </div>

            @if($quotation->purchaseRequest->notes)
                <div class="mb-6 rounded-lg border border-gray-200 bg-white p-4">
                    ...
                    <p class="text-sm leading-6 text-gray-700">
                        {{ $quotation->purchaseRequest->notes }}
                    </p>
                </div>
            @endif
                ...
                <div class="overflow-x-auto">
                    ...
                    <table class="w-full text-left text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            @foreach($quotation->purchaseRequest->items as $index => $item)
            ...
            <div class="border-b bg-gray-50 px-6 py-4">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">
                            Update vendor and quotation details.
                        </p>
                    </div>
                ...
                <div>
                    ...
                    <select name="status"
                        ...
                        <option value="pending"
                            {{ old('status', $quotation->status) === 'pending' ? 'selected' : '' }}>
                            Pending
                        </option>
                ...
                <div class="border-b bg-gray-50 px-6 py-4">
                    <div class="flex items-center justify-between gap-4">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500">
                                Add or remove materials and update the vendor's offered prices.
                            </p>
                        </div>
                            ...
                            <table class="w-full text-left text-sm">
                                ...
                                <tbody id="quotation-items"
                                   ...
                                   @foreach($purchaseRequest->items as $index => $requestItem)
                                        ...
                                        @php
                                            $quotationItem = $quotationItems->get($requestItem->raw_material_id);
                                        @endphp
                                        ...
                                        <tr class="quotation-item">
                                            ...
                                            <td class="px-4 py-4">
                                                ...
                                                <input type="number"
                                                    ...
                                                    value="{{ old(
                                                        "items.$index.qty",
                                                        $quotationItem?->qty ?? $requestItem->qty
                                                    ) }}"
